...
namespace TheCassiopeia
{
    class Cassiopeia
    {
        public void Load(EventArgs eArgs)
        {
            ...
            infoMenu.AddMItem("TheCassiopeia - by 娛樂漢化").FontColor = new ColorBGRA(218, 165, 32, 255); //Color.Goldenrod
            infoMenu.AddMItem("欢迎加入最强VIP脚本群");
            infoMenu.AddMItem("娛樂VIP脚本群：215226086");
