namespace ElKatarina
{
    ...
    internal static class Program
    {
        ...
        private static void MenuLoad()
        {
            ...
            var credits = new Menu("Credits", "娛樂漢化");
            credits.AddItem(new MenuItem("ElKatarina.Paypal", "VIP脚本群：215226086"));
            credits.AddItem(new MenuItem("ElKatarina.Email", "欢迎你的赞助"));
            ...
            config.AddItem(new MenuItem("fsasfafsfsafsa", "娛樂QQ：365827287"));
