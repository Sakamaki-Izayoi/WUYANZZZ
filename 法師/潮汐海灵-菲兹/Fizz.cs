namespace ElFizz
{
    ...
    internal class Fizz
    {
        ...
        /// </summary>
        private static float CalculateComboDamage(Obj_AI_Hero target, bool q, bool w, bool e, bool r)
        {
            try
            {
                if (target == null)
        ...
        private static void GenerateMenu()
        {
            try
            {
                Menu = new Menu("娛樂最强小鱼人", "娛樂最强小鱼人", true);
        ...
        /// </summary>
        private static bool Qkillable(Obj_AI_Hero target)
        {
            try
            {
        ...
        ///     R casting logic
        /// </summary>
        private static void RCastLogic(Obj_AI_Hero target)
        {
            try
            {
