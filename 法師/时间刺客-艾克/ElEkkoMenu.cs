...
namespace ElEkko
{
    public class ElEkkoMenu
    {
        ...
        public static void Initialize()
        {
            ...
            var credits = _menu.AddSubMenu(new Menu("Credits", "娛樂VIP脚本"));
            credits.AddItem(new MenuItem("ElRumble.Paypal", "娛樂VIP脚本群：215226086"));
            credits.AddItem(new MenuItem("ElRumble.Email", "365827287"));
