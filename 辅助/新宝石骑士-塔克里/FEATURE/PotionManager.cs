namespace SkyLv_Taric
{
    ...
    internal class PotionManager
    {
        ...
        {
            //Menu
            SkyLv_Taric.Menu.SubMenu("Misc").AddItem(new MenuItem("Taric.AutoPotion", "Use Auto Potion").SetValue(true));
        ...
        public static void PotionManagerFunction()
        {
            ...
            if (SkyLv_Taric.Menu.Item("Taric.AutoPotion").GetValue<bool>() && !Player.InFountain() && !Player.IsRecalling() && !Player.IsDead)
            {
