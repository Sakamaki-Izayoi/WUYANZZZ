...
namespace AmumuSharp
{
    internal class Amumu
    {
        ...
        public Amumu() //add Q near mouse (range), 
        {
            ...
            (_menu = new Menu("殇之木乃-阿木木", "AmumuSharp", true)).AddToMainMenu();
            ...
            messageMenu.AddItem(new MenuItem("Hanhua", "汉化:娱乐"));
            messageMenu.AddItem(new MenuItem("qqqun", "QQ群:215226086"));

            _menu.AddItem(new MenuItem("XiaoXiongMei", "无形装逼，最为致命"));
            ...
            Game.PrintChat("<font color=\"#1eff00\">娱乐汉化</font> - <font color=\"#00BFFF\">娱乐</font>");
        }
