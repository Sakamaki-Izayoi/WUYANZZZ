...
namespace ElSinged
{
    ...
    public class ElSingedMenu
    {
        ...
        public static void Initialize()
        {
            ...
            {
                credits.AddItem(new MenuItem("ElSinged.Paypal", "如果你喜欢这些脚本"));
                credits.AddItem(new MenuItem("ElSinged.Email", "请联系作者QQ365827287"));
            }
            ...
            Menu.AddItem(new MenuItem("fsasfafsfsafsa", "娛樂VIP群：215226086"));
